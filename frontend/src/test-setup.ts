...
window.wispApi = {
    ...
    organizeApplyBatch: () => Promise.resolve({ ok: true, batch_id: 'stub', status: 'APPLIED', applied: 0, failed: 0, partial: false, details: [] }),
    organizeUndoBatch: () => Promise.resolve({ ok: true, batch_id: 'stub', status: 'UNDONE', undone: 0, failed: 0, partial: false, details: [] }),
    organizeRegisterUndoBatch: () => Promise.resolve({ ok: true }),
    organizeClearUndoBatch: () => Promise.resolve({ ok: true }),
